...
<body data-page="budget" data-user-id="<?= (int)$_SESSION['user_id'] ?>">
  ...
  <main class="container py-4">
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
      <div>
        <h1 class="page-title mb-1">Budget</h1>
        <p class="text-secondary mb-0">Track category budgets and monitor spending progress.</p>
      </div>
      <button class="btn btn-primary px-4" data-bs-toggle="modal" data-bs-target="#budgetModal" id="openBudgetModalBtn">
    ...
    <div class="card app-card mb-4">
      <div class="card-body">
        <input type="text" id="budgetSearch" class="form-control" placeholder="Search budget category">
      </div>
    </div>
